...
const apiClient = axios.create({
  baseURL:
    ...
    'https://backend-vendor-production.up.railway.app/api',
  headers: {
...
export const fetchVariations = async (page: number = 1, limit: number = 5) => {
  try {
    const response = await apiClient.get(
      `/vendor/variations?page=${page}&limit=${limit}`
    );
    return response.data;
  } catch (error) {
    throw error;
...
export const linkVariationCategories = async (
  id: string,
  categories: string[]
) => {
  try {
    const response = await apiClient.patch(
      `/vendor/variations/${id}/categories`,
      {
...
export const fetchActiveCategories = async (
  ...
  try {
    const response = await apiClient.get(
      `/vendor/categories/active?page=${page}&limit=${limit}`
    );
    return response.data;
  } catch (error) {
    throw error;
...
export const getProducts = async (
  ...
  try {
    ...
    const response = await apiClient.get(
      `/vendor/products?${queryParams.toString()}`
    );
    return response.data;
  } catch (error: any) {
    throw new Error(
...
export const getProductById = async (productId: string) => {
  try {
    const response = await apiClient.get(
      `/vendor/products/${productId}?includeInactive=true`
    );
    return response.data;
  } catch (error: any) {
    throw new Error(error.response?.data?.message || 'Failed to fetch product');
...
export const addProductVariations = async (
  productId: string,
  variations: any[]
) => {
  try {
    const response = await apiClient.post(
      `/vendor/products/${productId}/variations`,
      { variations }
    );
    return response.data;
  } catch (error: any) {
    throw new Error(
      error.response?.data?.message || 'Failed to add product variations'
    );
  }
};
...
export const updateProductVariation = async (
  ...
  try {
    const response = await apiClient.put(
      `/vendor/products/${productId}/variations/${variationId}`,
      data
    );
    return response.data;
  } catch (error: any) {
    throw new Error(
      error.response?.data?.message || 'Failed to update product variation'
    );
  }
};
...
export const deleteProductVariation = async (
  ...
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to delete product variation'
    );
  }
};
...
export const toggleProductVisibility = async (
  ...
  try {
    const response = await apiClient.patch(
      `/vendor/products/${productId}/visibility`,
      { status }
    );
    return response.data;
  } catch (error: any) {
...
export const getCategoryVariations = async (categoryId: string) => {
  try {
    const response = await apiClient.get(
      `/vendor/categories/${categoryId}/variations`
    );
    return response.data;
  } catch (error: any) {
    throw new Error(
      error.response?.data?.message || 'Failed to fetch category variations'
    );
  }
};
...
export const deleteMethod = async (methodId: string) => {
  try {
    const response = await apiClient.delete(
      `/vendor/shipping-methods/${methodId}`
    );
    return response.data;
  } catch (error: any) {
...
export const updateZoneMethod = async (methodId: string, data: any) => {
  try {
    const response = await apiClient.put(
      `/vendor/shipping-methods/${methodId}`,
      data
...
export const getSingleMethod = async (id: string) => {
  try {
    const response = await apiClient.get(
      `/vendor/zones/${id}/shipping-methods`
    );
    return response.data;
  } catch (error: any) {
...
export const checkUserNameAvailbility = async (username: string) => {
  try {
    const response = await apiClient.get(
      `/vendor/store/username/availability?userName=${username}`
    );
    return response.data;
  } catch (error: any) {
    throw (
      error.response?.data ||
      error.message ||
      'Failed to check username availbility'
    );
  }
};
...
export const getShippingSetups = async (
  page: number = 1,
  limit: number = 10
) => {
  try {
    const response = await apiClient.get(
      `/vendor/shipping-providers?page=${page}&limit=${limit}`
    );
    return response.data;
  } catch (error: any) {
    throw new Error(
      error.response?.data?.message || 'Failed to fetch active Shiping setups'
    );
  }
};
...
export const getShippingSetupsMinimals = async () => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to fetch Shiping setups'
    );
  }
};
...
export const toggleShippingSetup = async (id: string) => {
  try {
    const response = await apiClient.patch(
      `/vendor/shipping-providers/${id}/toggle-status`
    );
    return response.data;
  } catch (error: any) {
    throw new Error(
      error.response?.data?.message || 'Failed to udpate the status'
    );
  }
};
...
export const deleteShippingSetup = async (id: string) => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to delete the status'
    );
  }
};
...
export const createShippingSetup = async (data: {
  ...
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to create ShippingSetup'
    );
  }
};

export const updateShippingSetup = async (
  id: string,
  data: {
    providerName?: string;
    trackingUrl?: string;
  ...
  try {
    const response = await apiClient.put(
      `/vendor/shipping-providers/${id}`,
      data
    );
    return response.data;
  } catch (error: any) {
    throw new Error(
      error.response?.data?.message || 'Failed to update ShippingSetup'
    );
  }
};
...
export const getShippingSetup = async () => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to fetch Shiping type'
    );
  }
};
...
export const createShippingInformation = async (data: {
  ...
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to create Shipping Information'
    );
  }
};
  ...
  try {
    ...
    throw new Error(
      error.response?.data?.message ||
        'Failed to delete the Shipping Information'
    );
  }
};
...
export const updateShippingInformation = async (
  ...
  try {
    const response = await apiClient.put(
      `/vendor/shipping-policies/${id}`,
      data
    );
    return response.data;
  } catch (error: any) {
    throw new Error(
      error.response?.data?.message || 'Failed to update Shipping Information'
    );
  }
};
...
export const getShippingInformation = async () => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to fetch Shiping information'
    );
  }
};

export const updateShippingMode = async (data: { shippingType?: string }) => {
  try {
    const response = await apiClient.put(`/vendor/shipping-type`, data);
    return response.data;
  } catch (error: any) {
    throw new Error(
      error.response?.data?.message || 'Failed to update Shipping Mode'
    );
  }
};
...
export const getShippingZone = async () => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to fetch Shiping zones'
    );
  }
};
...
export const getSingleShippingZone = async (id: string) => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to fetch Shiping zone'
    );
  }
};
...
export const deleteShippingZone = async (id: string) => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to delete the zones'
    );
  }
};
...
export const getShippingMethods = async (id: string) => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to fetch Shiping mthods'
    );
  }
};
...
export const getVerificationDocumnets = async () => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to fetch Verification Documnets'
    );
  }
};
...
export const createVerificationDocumnet = async (data: {
  ...
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to create Verification Documnet'
    );
  }
};

export const updateVerificationDocumnet = async (
  id: string,
  data: {
    documentType?: string;
    fileUrl?: string;
  ...
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to update Verification Documnet'
    );
  }
};
...
export const deleteVerificationDocumnet = async (id: string) => {
  try {
    ...
    throw new Error(
      error.response?.data?.message ||
        'Failed to delete the Verification Documnet'
    );
  }
};
...
export const getSingleVerificationDocumnet = async (id: string) => {
  try {
    ...
    throw new Error(
      error.response?.data?.message || 'Failed to fetch Verification Documnet'
    );
  }
};
...
export const fetchVendorReviews = async (
  ...
  try {
    ...
    const response = await apiClient.get(
      `/vendor/reviews?${queryParams.toString()}`
    );
    return response.data;
  } catch (error: any) {
